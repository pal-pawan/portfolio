...
const Navbar = () => {
  return (
    <>
    <nav className="flex justify-between align-middle py-4 px-2 text-grey-300 font-bold w-full bg-slate-200 absolute top-0">
    <div className="font-bold text-3xl align-middle px-3"><h1 className='bg-black text-white rounded-full shadow p-3 cursor-pointer hover:scale-110 hover:shadow-lg transition-all delay-300 hover:text-orange-500 hover:bg-slate-700'>PP</h1></div>
